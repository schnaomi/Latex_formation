...
2 - Go on PLMLatex or Overleaf  
3 - Login with your university account  
4 - Create a new project  
5 - Import all files in the new project  
6 - You can change the main.tex document, add new files, new pdfs, news figures, new bibliography etc..  
